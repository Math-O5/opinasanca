module MapLocationsHelper
  ...
  def render_map(map_location, parent_class, editable, remove_marker_label, investments_coordinates=nil, sugestion_coordinates=nil)
    map_location = MapLocation.new if map_location.nil?
    map = content_tag_for :div,
                          map_location,
                          class: "map",
                          data: prepare_map_settings(map_location, editable, parent_class, investments_coordinates, sugestion_coordinates)
  ...
  def prepare_map_settings(map_location, editable, parent_class, investments_coordinates=nil, sugestion_coordinates=nil, op_mark = 0)
    options = {
      map: "",
      ...
      marker_sugestions_coordinates: sugestion_coordinates
